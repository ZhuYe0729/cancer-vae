...
TEST_RESULTS_PATH = '/root/wja/wja/project/tsnpe_neurips/my/test_results_snpe.npz'

samples_params = {
    'sample1': {
        'mutation_rates': 88.7368,
        'selective_advantages': 10.6356,
        'death_rates': 0.0000,
        'aggressions': 0.4961,
        'time_to_new_clone': 6.4838
    },
    'sample2': {
        'mutation_rates': 51.8890,
        'selective_advantages': 10.5902,
        'death_rates': 0.0000,
        'aggressions': 0.1287,
        'time_to_new_clone': 6.9228
    },
    'sample3': {
        'mutation_rates': 18.7968,
        'selective_advantages': 9.9682,
        'death_rates': 0.0000,
        'aggressions': 0.7013,
        'time_to_new_clone': 6.4315
    },
    'sample4': {
        'mutation_rates': 12.0906,
        'selective_advantages': 10.0854,
        'death_rates': 0.0000,
        'aggressions': 0.6741,
        'time_to_new_clone': 6.7891
    },
    'sample5': {
        'mutation_rates': 37.1375,
        'selective_advantages': 10.9553,
        'death_rates': 0.0000,
        'aggressions': 0.0917,
        'time_to_new_clone': 7.0468
    },
}
