...
samples_params = {
    'sample1': {
        'mutation_rates': 53.4743,
        'selective_advantages': 10.5625,
        'death_rates': 0.4740,
        'aggressions': 0.5247,
        'time_to_new_clone': 6.9415
    },
    'sample2': {
        'mutation_rates': 50.0773,
        'selective_advantages': 10.8119,
        'death_rates': 0.4869,
        'aggressions': 0.5141,
        'time_to_new_clone': 7.5314
    },
    'sample3': {
        'mutation_rates': 48.4021,
        'selective_advantages': 10.4658,
        'death_rates': 0.5055,
        'aggressions': 0.4846,
        'time_to_new_clone': 7.5388
    },
    'sample4': {
        'mutation_rates': 19.3737,
        'selective_advantages': 10.2103,
        'death_rates': 0.0000,
        'aggressions': 0.4018,
        'time_to_new_clone': 7.9984
    },
    'sample5': {
        'mutation_rates': 50.4324,
        'selective_advantages': 10.4360,
        'death_rates': 0.5047,
        'aggressions': 0.5128,
        'time_to_new_clone': 8.2218
    },
}
